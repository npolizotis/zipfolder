...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.zipfolder.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".zipfolder" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".zipfolder")
	}
